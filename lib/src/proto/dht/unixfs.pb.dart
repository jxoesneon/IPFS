...
class Data extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Data', package: const $pb.PackageName(_omitMessageNames ? '' : 'ipfs.unixfs'), createEmptyInstance: create)
    ..e<Data_DataType>(1, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: Data_DataType.RAW, valueOf: Data_DataType.valueOf, enumValues: Data_DataType.values)
    ...
    ..a<$fixnum.Int64>(5, _omitFieldNames ? '' : 'hashType', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
...
class Metadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Metadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'ipfs.unixfs'), createEmptyInstance: create)
...
class UnixTime extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UnixTime', package: const $pb.PackageName(_omitMessageNames ? '' : 'ipfs.unixfs'), createEmptyInstance: create)
    ..aInt64(1, _omitFieldNames ? '' : 'seconds')
    ..a<$core.int>(2, _omitFieldNames ? '' : 'fractionalNanoseconds', $pb.PbFieldType.OF3)
    ..hasRequiredFields = false
  ;
