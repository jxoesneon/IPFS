...
import 'common_tree.pbenum.dart';
import 'google/protobuf/timestamp.pb.dart' as $0;

export 'common_tree.pbenum.dart';
...
class PeerId extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PeerId', package: const $pb.PackageName(_omitMessageNames ? '' : 'ipfs.dht.common'), createEmptyInstance: create)
...
class Node extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Node', package: const $pb.PackageName(_omitMessageNames ? '' : 'ipfs.dht.common'), createEmptyInstance: create)
...
class K_PeerId extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'K_PeerId', package: const $pb.PackageName(_omitMessageNames ? '' : 'ipfs.dht.common'), createEmptyInstance: create)
...
class V_PeerInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'V_PeerInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'ipfs.dht.common'), createEmptyInstance: create)
