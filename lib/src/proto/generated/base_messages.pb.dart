...
class IPFSMessage extends $pb.GeneratedMessage {
  ...
  IPFSMessage._() : super();
  factory IPFSMessage.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory IPFSMessage.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'IPFSMessage', package: const $pb.PackageName(_omitMessageNames ? '' : 'ipfs.base'), createEmptyInstance: create)
    ...
    ..e<IPFSMessage_MessageType>(5, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: IPFSMessage_MessageType.UNKNOWN, valueOf: IPFSMessage_MessageType.valueOf, enumValues: IPFSMessage_MessageType.values)
  ...
  'Will be removed in next major version')
  IPFSMessage copyWith(void Function(IPFSMessage) updates) => super.copyWith((message) => updates(message as IPFSMessage)) as IPFSMessage;
  ...
  @$core.pragma('dart2js:noInline')
  static IPFSMessage getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<IPFSMessage>(create);
  ...
  @$pb.TagNumber(5)
  set type(IPFSMessage_MessageType v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class NetworkEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NetworkEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'ipfs.base'), createEmptyInstance: create)
