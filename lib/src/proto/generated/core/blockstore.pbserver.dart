...
abstract class BlockStoreServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$3.GetBlockResponse> getBlock($pb.ServerContext ctx, $0.IPFSCIDProto request);
  $async.Future<$3.RemoveBlockResponse> removeBlock($pb.ServerContext ctx, $0.IPFSCIDProto request);
  $async.Future<$1.BlockProto> getAllBlocks($pb.ServerContext ctx, $2.Empty request);

  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      case 'AddBlock': return $1.BlockProto();
      case 'GetBlock': return $0.IPFSCIDProto();
      case 'RemoveBlock': return $0.IPFSCIDProto();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String methodName, $pb.GeneratedMessage request) {
    switch (methodName) {
      ...
      case 'GetBlock': return this.getBlock(ctx, request as $0.IPFSCIDProto);
      case 'RemoveBlock': return this.removeBlock(ctx, request as $0.IPFSCIDProto);
