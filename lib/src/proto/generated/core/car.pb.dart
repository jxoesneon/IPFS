...
class CarProto extends $pb.GeneratedMessage {
  factory CarProto({
    ...
    $core.Map<$core.String, $1.Any>? pragma,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CarProto', package: const $pb.PackageName(_omitMessageNames ? '' : 'ipfs.core.data_structures'), createEmptyInstance: create)
    ...
    ..m<$core.String, $1.Any>(3, _omitFieldNames ? '' : 'pragma', entryClassName: 'CarProto.PragmaEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $1.Any.create, valueDefaultOrMaker: $1.Any.getDefault, packageName: const $pb.PackageName('ipfs.core.data_structures'))
  ...
  @$pb.TagNumber(3)
  $core.Map<$core.String, $1.Any> get pragma => $_getMap(2);
...
class CarHeader extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CarHeader', package: const $pb.PackageName(_omitMessageNames ? '' : 'ipfs.core.data_structures'), createEmptyInstance: create)
    ...
    ..m<$core.String, $1.Any>(4, _omitFieldNames ? '' : 'pragma', entryClassName: 'CarHeader.PragmaEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $1.Any.create, valueDefaultOrMaker: $1.Any.getDefault, packageName: const $pb.PackageName('ipfs.core.data_structures'))
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $core.Map<$core.String, $1.Any> get pragma => $_getMap(3);
}
