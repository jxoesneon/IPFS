...
class NodeProto extends $pb.GeneratedMessage {
  ...
  NodeProto._() : super();
  factory NodeProto.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory NodeProto.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$5.PBLink>(2, _omitFieldNames ? '' : 'links', $pb.PbFieldType.PM,
        subBuilder: $5.PBLink.create)
    ..a<$core.List<$core.int>>(
        3, _omitFieldNames ? '' : 'data', $pb.PbFieldType.OY)
    ..e<$4.NodeTypeProto>(4, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE,
