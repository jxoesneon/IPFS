...
class NodeProto extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NodeProto', package: const $pb.PackageName(_omitMessageNames ? '' : 'ipfs.core.data_structures'), createEmptyInstance: create)
    ...
    ..e<$6.NodeTypeProto>(4, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $6.NodeTypeProto.NODE_TYPE_UNSPECIFIED, valueOf: $6.NodeTypeProto.valueOf, enumValues: $6.NodeTypeProto.values)
  ...
  @$pb.TagNumber(4)
  $6.NodeTypeProto get type => $_getN(3);
  @$pb.TagNumber(4)
  set type($6.NodeTypeProto v) { setField(4, v); }
  @$pb.TagNumber(4)
