...
class BlockStoreServiceApi {
  ...
  ;
  $async.Future<GetBlockResponse> getBlock($pb.ClientContext? ctx, $0.CIDProto request) =>
    _client.invoke<GetBlockResponse>(ctx, 'BlockStoreService', 'GetBlock', request, GetBlockResponse())
  ;
  $async.Future<RemoveBlockResponse> removeBlock($pb.ClientContext? ctx, $0.CIDProto request) =>
