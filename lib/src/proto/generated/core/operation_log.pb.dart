...
class OperationLogEntryProto extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OperationLogEntryProto', package: const $pb.PackageName(_omitMessageNames ? '' : 'ipfs.core.data_structures'), createEmptyInstance: create)
    ...
    ..aOM<$2.IPFSCIDProto>(4, _omitFieldNames ? '' : 'cid', subBuilder: $2.IPFSCIDProto.create)
    ..e<$4.NodeTypeProto>(5, _omitFieldNames ? '' : 'nodeType', $pb.PbFieldType.OE, defaultOrMaker: $4.NodeTypeProto.NODE_TYPE_UNSPECIFIED, valueOf: $4.NodeTypeProto.valueOf, enumValues: $4.NodeTypeProto.values)
  ...
  @$pb.TagNumber(4)
  set cid($2.IPFSCIDProto v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set nodeType($4.NodeTypeProto v) { setField(5, v); }
  @$pb.TagNumber(5)
