...
class ConnectionState extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConnectionState', package: const $pb.PackageName(_omitMessageNames ? '' : 'ipfs.connection'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'peerId')
    ..e<ConnectionState_Status>(2, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: ConnectionState_Status.UNKNOWN, valueOf: ConnectionState_Status.valueOf, enumValues: ConnectionState_Status.values)
    ..aOM<$7.Timestamp>(3, _omitFieldNames ? '' : 'connectedAt', subBuilder: $7.Timestamp.create)
    ..m<$core.String, $core.String>(4, _omitFieldNames ? '' : 'metadata', entryClassName: 'ConnectionState.MetadataEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('ipfs.connection'))
  ...
  @$pb.TagNumber(2)
  set status(ConnectionState_Status v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set connectedAt($7.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class ConnectionMetrics extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConnectionMetrics', package: const $pb.PackageName(_omitMessageNames ? '' : 'ipfs.connection'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'peerId')
    ..a<$fixnum.Int64>(2, _omitFieldNames ? '' : 'messagesSent', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$fixnum.Int64>(3, _omitFieldNames ? '' : 'messagesReceived', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$fixnum.Int64>(4, _omitFieldNames ? '' : 'bytesSent', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$fixnum.Int64>(5, _omitFieldNames ? '' : 'bytesReceived', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$core.int>(6, _omitFieldNames ? '' : 'averageLatencyMs', $pb.PbFieldType.OU3)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set messagesSent($fixnum.Int64 v) { $_setInt64(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set messagesReceived($fixnum.Int64 v) { $_setInt64(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set bytesSent($fixnum.Int64 v) { $_setInt64(3, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set bytesReceived($fixnum.Int64 v) { $_setInt64(4, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set averageLatencyMs($core.int v) { $_setUnsignedInt32(5, v); }
  @$pb.TagNumber(6)
