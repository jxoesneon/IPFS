...
final $typed_data.Uint8List protocolConfigDescriptor = $convert
    .base64Decode('Cg5Qcm90b2NvbENvbmZpZxIfCgtwcm90b2NvbF9pZBgBIAEoCVIKcHJvdG9jb2xJZBI2ChdtZX'
...
final $typed_data.Uint8List rateLimitConfigDescriptor = $convert
    .base64Decode('Cg9SYXRlTGltaXRDb25maWcSNQoXbWF4X3JlcXVlc3RzX3Blcl93aW5kb3cYASABKA1SFG1heF'
...
final $typed_data.Uint8List circuitBreakerConfigDescriptor = $convert
    .base64Decode('ChRDaXJjdWl0QnJlYWtlckNvbmZpZxIyChVyZXNldF90aW1lb3V0X3NlY29uZHMYASABKA1SE3'
