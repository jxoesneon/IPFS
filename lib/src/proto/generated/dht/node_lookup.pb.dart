...
class NodeLookupRequest extends $pb.GeneratedMessage {
  ...
  factory NodeLookupRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory NodeLookupRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  static $pb.PbList<NodeLookupRequest> createRepeated() =>
      $pb.PbList<NodeLookupRequest>();
  @$core.pragma('dart2js:noInline')
...
class NodeLookupResponse extends $pb.GeneratedMessage {
  ...
  factory NodeLookupResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory NodeLookupResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..pc<$9.KademliaId>(
        1, _omitFieldNames ? '' : 'closestNodes', $pb.PbFieldType.PM,
        subBuilder: $9.KademliaId.create)
    ..hasRequiredFields = false;
  ...
  static $pb.PbList<NodeLookupResponse> createRepeated() =>
      $pb.PbList<NodeLookupResponse>();
  @$core.pragma('dart2js:noInline')
