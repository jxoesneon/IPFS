...
class FindClosestPeersRequest extends $pb.GeneratedMessage {
  ...
  factory FindClosestPeersRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory FindClosestPeersRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$9.KademliaId>(1, _omitFieldNames ? '' : 'target',
  ...
  FindClosestPeersRequest clone() =>
      FindClosestPeersRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
  ...
  static $pb.PbList<FindClosestPeersRequest> createRepeated() =>
      $pb.PbList<FindClosestPeersRequest>();
  @$core.pragma('dart2js:noInline')
...
class FindClosestPeersResponse extends $pb.GeneratedMessage {
  factory FindClosestPeersResponse({
    $core.Iterable<$9.KademliaId>? peerIds,
  }) {
    final $result = create();
    if (peerIds != null) {
  ...
  factory FindClosestPeersResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory FindClosestPeersResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'ipfs.dht.find_closest_peers'),
      createEmptyInstance: create)
    ..pc<$9.KademliaId>(1, _omitFieldNames ? '' : 'peerIds', $pb.PbFieldType.PM,
        subBuilder: $9.KademliaId.create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  FindClosestPeersResponse clone() =>
      FindClosestPeersResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ...
  static $pb.PbList<FindClosestPeersResponse> createRepeated() =>
      $pb.PbList<FindClosestPeersResponse>();
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $core.List<$9.KademliaId> get peerIds => $_getList(0);
}
