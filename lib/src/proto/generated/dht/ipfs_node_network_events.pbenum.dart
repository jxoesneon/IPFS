...
class NodeErrorEvent_ErrorType extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, NodeErrorEvent_ErrorType> _byValue =
...
class NetworkStatusChangedEvent_ChangeType extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, NetworkStatusChangedEvent_ChangeType>
      _byValue = $pb.ProtobufEnum.initByValue(values);
  static NetworkStatusChangedEvent_ChangeType? valueOf($core.int value) =>
      _byValue[value];

  const NetworkStatusChangedEvent_ChangeType._($core.int v, $core.String n)
      : super(v, n);
}
