...
final $typed_data.Uint8List networkEventDescriptor = $convert
    .base64Decode('CgxOZXR3b3JrRXZlbnQSUAoOcGVlcl9jb25uZWN0ZWQYASABKAsyJy5pcGZzLmNvcmUuaXBmc1'
...
final $typed_data.Uint8List peerConnectedEventDescriptor = $convert
    .base64Decode('ChJQZWVyQ29ubmVjdGVkRXZlbnQSFwoHcGVlcl9pZBgBIAEoCVIGcGVlcklkEiIKDG11bHRpYW'
...
final $typed_data.Uint8List peerDisconnectedEventDescriptor = $convert
    .base64Decode('ChVQZWVyRGlzY29ubmVjdGVkRXZlbnQSFwoHcGVlcl9pZBgBIAEoCVIGcGVlcklkEhYKBnJlYX'
...
final $typed_data.Uint8List connectionAttemptedEventDescriptor = $convert
    .base64Decode('ChhDb25uZWN0aW9uQXR0ZW1wdGVkRXZlbnQSFwoHcGVlcl9pZBgBIAEoCVIGcGVlcklkEhgKB3'
...
final $typed_data.Uint8List connectionFailedEventDescriptor = $convert
    .base64Decode('ChVDb25uZWN0aW9uRmFpbGVkRXZlbnQSFwoHcGVlcl9pZBgBIAEoCVIGcGVlcklkEhYKBnJlYX'
        'NvbhgCIAEoCVIGcmVhc29u');
...
final $typed_data.Uint8List messageReceivedEventDescriptor = $convert
    .base64Decode('ChRNZXNzYWdlUmVjZWl2ZWRFdmVudBIXCgdwZWVyX2lkGAEgASgJUgZwZWVySWQSJwoPbWVzc2'
...
final $typed_data.Uint8List messageSentEventDescriptor = $convert
    .base64Decode('ChBNZXNzYWdlU2VudEV2ZW50EhcKB3BlZXJfaWQYASABKAlSBnBlZXJJZBInCg9tZXNzYWdlX2'
...
final $typed_data.Uint8List blockReceivedEventDescriptor = $convert
    .base64Decode('ChJCbG9ja1JlY2VpdmVkRXZlbnQSEAoDY2lkGAEgASgJUgNjaWQSFwoHcGVlcl9pZBgCIAEoCV'
        'IGcGVlcklk');
...
final $typed_data.Uint8List blockSentEventDescriptor = $convert
    .base64Decode('Cg5CbG9ja1NlbnRFdmVudBIQCgNjaWQYASABKAlSA2NpZBIXCgdwZWVyX2lkGAIgASgJUgZwZW'
        'VySWQ=');
...
final $typed_data.Uint8List dHTQueryStartedEventDescriptor = $convert
    .base64Decode('ChRESFRRdWVyeVN0YXJ0ZWRFdmVudBIdCgpxdWVyeV90eXBlGAEgASgJUglxdWVyeVR5cGUSHQ'
...
final $typed_data.Uint8List dHTQueryCompletedEventDescriptor = $convert
    .base64Decode('ChZESFRRdWVyeUNvbXBsZXRlZEV2ZW50Eh0KCnF1ZXJ5X3R5cGUYASABKAlSCXF1ZXJ5VHlwZR'
...
final $typed_data.Uint8List dHTValueFoundEventDescriptor = $convert
    .base64Decode('ChJESFRWYWx1ZUZvdW5kRXZlbnQSEAoDa2V5GAEgASgJUgNrZXkSFAoFdmFsdWUYAiABKAxSBX'
...
final $typed_data.Uint8List dHTValueNotFoundEventDescriptor =
    $convert.base64Decode('ChVESFRWYWx1ZU5vdEZvdW5kRXZlbnQSEAoDa2V5GAEgASgJUgNrZXk=');
...
final $typed_data.Uint8List dHTValueProvidedEventDescriptor = $convert
    .base64Decode('ChVESFRWYWx1ZVByb3ZpZGVkRXZlbnQSEAoDa2V5GAEgASgJUgNrZXkSFAoFdmFsdWUYAiABKA'
        'xSBXZhbHVl');
...
final $typed_data.Uint8List dHTProviderAddedEventDescriptor = $convert
    .base64Decode('ChVESFRQcm92aWRlckFkZGVkRXZlbnQSEAoDa2V5GAEgASgJUgNrZXkSFwoHcGVlcl9pZBgCIA'
        'EoCVIGcGVlcklk');
...
final $typed_data.Uint8List dHTProviderQueriedEventDescriptor = $convert
    .base64Decode('ChdESFRQcm92aWRlclF1ZXJpZWRFdmVudBIQCgNrZXkYASABKAlSA2tleRIcCglwcm92aWRlcn'
...
final $typed_data.Uint8List pubsubMessagePublishedEventDescriptor = $convert
    .base64Decode('ChtQdWJzdWJNZXNzYWdlUHVibGlzaGVkRXZlbnQSFAoFdG9waWMYASABKAlSBXRvcGljEicKD2'
...
final $typed_data.Uint8List pubsubMessageReceivedEventDescriptor = $convert
    .base64Decode('ChpQdWJzdWJNZXNzYWdlUmVjZWl2ZWRFdmVudBIUCgV0b3BpYxgBIAEoCVIFdG9waWMSJwoPbW'
...
final $typed_data.Uint8List pubsubSubscriptionCreatedEventDescriptor = $convert
    .base64Decode('Ch5QdWJzdWJTdWJzY3JpcHRpb25DcmVhdGVkRXZlbnQSFAoFdG9waWMYASABKAlSBXRvcGlj');
...
final $typed_data.Uint8List pubsubSubscriptionCancelledEventDescriptor = $convert
    .base64Decode('CiBQdWJzdWJTdWJzY3JpcHRpb25DYW5jZWxsZWRFdmVudBIUCgV0b3BpYxgBIAEoCVIFdG9waW'
        'M=');
...
final $typed_data.Uint8List circuitRelayCreatedEventDescriptor = $convert
    .base64Decode('ChhDaXJjdWl0UmVsYXlDcmVhdGVkRXZlbnQSIwoNcmVsYXlfYWRkcmVzcxgBIAEoCVIMcmVsYX'
        'lBZGRyZXNz');
...
final $typed_data.Uint8List circuitRelayClosedEventDescriptor = $convert
    .base64Decode('ChdDaXJjdWl0UmVsYXlDbG9zZWRFdmVudBIjCg1yZWxheV9hZGRyZXNzGAEgASgJUgxyZWxheU'
...
final $typed_data.Uint8List circuitRelayTrafficEventDescriptor = $convert
    .base64Decode('ChhDaXJjdWl0UmVsYXlUcmFmZmljRXZlbnQSIwoNcmVsYXlfYWRkcmVzcxgBIAEoCVIMcmVsYX'
...
final $typed_data.Uint8List circuitRelayDataReceivedEventDescriptor = $convert
    .base64Decode('Ch1DaXJjdWl0UmVsYXlEYXRhUmVjZWl2ZWRFdmVudBIjCg1yZWxheV9hZGRyZXNzGAEgASgJUg'
...
final $typed_data.Uint8List circuitRelayDataSentEventDescriptor = $convert
    .base64Decode('ChlDaXJjdWl0UmVsYXlEYXRhU2VudEV2ZW50EiMKDXJlbGF5X2FkZHJlc3MYASABKAlSDHJlbG'
...
final $typed_data.Uint8List circuitRelayFailedEventDescriptor = $convert
    .base64Decode('ChdDaXJjdWl0UmVsYXlGYWlsZWRFdmVudBIjCg1yZWxheV9hZGRyZXNzGAEgASgJUgxyZWxheU'
        'FkZHJlc3MSFgoGcmVhc29uGAIgASgJUgZyZWFzb24=');
...
final $typed_data.Uint8List streamStartedEventDescriptor = $convert
    .base64Decode('ChJTdHJlYW1TdGFydGVkRXZlbnQSGwoJc3RyZWFtX2lkGAEgASgJUghzdHJlYW1JZBIXCgdwZW'
...
final $typed_data.Uint8List streamEndedEventDescriptor = $convert
    .base64Decode('ChBTdHJlYW1FbmRlZEV2ZW50EhsKCXN0cmVhbV9pZBgBIAEoCVIIc3RyZWFtSWQSFwoHcGVlcl'
...
final $typed_data.Uint8List peerDiscoveredEventDescriptor =
    $convert.base64Decode('ChNQZWVyRGlzY292ZXJlZEV2ZW50EhcKB3BlZXJfaWQYASABKAlSBnBlZXJJZA==');
...
final $typed_data.Uint8List nodeErrorEventDescriptor = $convert
    .base64Decode('Cg5Ob2RlRXJyb3JFdmVudBJMCgplcnJvcl90eXBlGAEgASgOMi0uaXBmcy5jb3JlLmlwZnNfbm'
...
final $typed_data.Uint8List networkStatusChangedEventDescriptor = $convert
    .base64Decode('ChlOZXR3b3JrU3RhdHVzQ2hhbmdlZEV2ZW50EloKC2NoYW5nZV90eXBlGAEgASgOMjkuaXBmcy'
...
final $typed_data.Uint8List resourceLimitExceededEventDescriptor = $convert
    .base64Decode('ChpSZXNvdXJjZUxpbWl0RXhjZWVkZWRFdmVudBIjCg1yZXNvdXJjZV90eXBlGAEgASgJUgxyZX'
...
final $typed_data.Uint8List systemAlertEventDescriptor = $convert
    .base64Decode('ChBTeXN0ZW1BbGVydEV2ZW50Eh0KCmFsZXJ0X3R5cGUYASABKAlSCWFsZXJ0VHlwZRIYCgdtZX'
