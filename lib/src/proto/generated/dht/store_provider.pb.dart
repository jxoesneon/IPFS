...
import 'common_red_black_tree.pb.dart' as $8;
...
class StoreProviderRequest extends $pb.GeneratedMessage {
  ...
  factory StoreProviderRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory StoreProviderRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$8.V_PeerInfo>(2, _omitFieldNames ? '' : 'providerInfo',
  ...
  StoreProviderRequest clone() =>
      StoreProviderRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
  ...
  static $pb.PbList<StoreProviderRequest> createRepeated() =>
      $pb.PbList<StoreProviderRequest>();
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $8.K_PeerId ensureKey() => $_ensure(0);

  /// The provider information to store
  @$pb.TagNumber(2)
  $8.V_PeerInfo get providerInfo => $_getN(1);
  @$pb.TagNumber(2)
  set providerInfo($8.V_PeerInfo v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $8.V_PeerInfo ensureProviderInfo() => $_ensure(1);
...
class StoreProviderResponse extends $pb.GeneratedMessage {
  ...
  factory StoreProviderResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory StoreProviderResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'ipfs.dht.store_provider'),
      createEmptyInstance: create)
    ..e<StoreProviderResponse_Status>(
        1, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE,
        defaultOrMaker: StoreProviderResponse_Status.SUCCESS,
        valueOf: StoreProviderResponse_Status.valueOf,
        enumValues: StoreProviderResponse_Status.values)
    ..aOS(2, _omitFieldNames ? '' : 'errorMessage')
    ..a<$core.int>(
        3, _omitFieldNames ? '' : 'replicationCount', $pb.PbFieldType.O3)
    ..hasRequiredFields = false;

  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  StoreProviderResponse clone() =>
      StoreProviderResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ...
  static $pb.PbList<StoreProviderResponse> createRepeated() =>
      $pb.PbList<StoreProviderResponse>();
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set status(StoreProviderResponse_Status v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(3)
  set replicationCount($core.int v) {
    $_setSignedInt32(2, v);
  }
...
class GetProvidersRequest extends $pb.GeneratedMessage {
  ...
  factory GetProvidersRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GetProvidersRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
...
class GetProvidersResponse extends $pb.GeneratedMessage {
  factory GetProvidersResponse({
    $core.Iterable<$8.V_PeerInfo>? providers,
    $core.Iterable<$8.V_PeerInfo>? closestPeers,
  }) {
    final $result = create();
    if (providers != null) {
  ...
  factory GetProvidersResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GetProvidersResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$8.V_PeerInfo>(
        ...
        subBuilder: $8.V_PeerInfo.create)
    ..pc<$8.V_PeerInfo>(
        2, _omitFieldNames ? '' : 'closestPeers', $pb.PbFieldType.PM,
        subBuilder: $8.V_PeerInfo.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $core.List<$8.V_PeerInfo> get providers => $_getList(0);

  /// Closest peers that might have the provider information
  @$pb.TagNumber(2)
  $core.List<$8.V_PeerInfo> get closestPeers => $_getList(1);
}
