...
class RoutingTableProto extends $pb.GeneratedMessage {
  factory RoutingTableProto({
    $core.Map<$core.String, $10.KademliaNode>? entries,
  }) {
    final $result = create();
    if (entries != null) {
  ...
  factory RoutingTableProto.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory RoutingTableProto.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..m<$core.String, $10.KademliaNode>(1, _omitFieldNames ? '' : 'entries',
        entryClassName: 'RoutingTableProto.EntriesEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.OM,
        valueCreator: $10.KademliaNode.create,
        valueDefaultOrMaker: $10.KademliaNode.getDefault,
  ...
  static $pb.PbList<RoutingTableProto> createRepeated() =>
      $pb.PbList<RoutingTableProto>();
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $core.Map<$core.String, $10.KademliaNode> get entries => $_getMap(0);
}
