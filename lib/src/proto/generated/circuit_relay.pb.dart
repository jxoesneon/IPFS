...
class Reservation extends $pb.GeneratedMessage {
  factory Reservation({
    ...
    if (limitDuration != null) {
      $result.limitDuration = limitDuration;
    }
    if (limitData != null) {
  ...
  @$pb.TagNumber(2)
  void clearLimitDuration() => clearField(2);
  ...
  @$pb.TagNumber(3)
  void clearLimitData() => clearField(3);

  @$pb.TagNumber(4)
  $core.List<$core.List<$core.int>> get addrs => $_getList(3);
}
