...
class Status extends $pb.ProtobufEnum {
  ...
  static const Status HOP_SRC_ADDR_TOO_LONG = Status._(220, _omitEnumNames ? '' : 'HOP_SRC_ADDR_TOO_LONG');
  static const Status HOP_DST_ADDR_TOO_LONG = Status._(221, _omitEnumNames ? '' : 'HOP_DST_ADDR_TOO_LONG');
  static const Status HOP_SRC_MULTIADDR_INVALID = Status._(222, _omitEnumNames ? '' : 'HOP_SRC_MULTIADDR_INVALID');
  static const Status HOP_DST_MULTIADDR_INVALID = Status._(223, _omitEnumNames ? '' : 'HOP_DST_MULTIADDR_INVALID');
  static const Status HOP_NO_CONN_TO_DST = Status._(260, _omitEnumNames ? '' : 'HOP_NO_CONN_TO_DST');
  static const Status HOP_CANT_DIAL_DST = Status._(261, _omitEnumNames ? '' : 'HOP_CANT_DIAL_DST');
  static const Status HOP_CANT_OPEN_DST_STREAM = Status._(262, _omitEnumNames ? '' : 'HOP_CANT_OPEN_DST_STREAM');
  static const Status HOP_CANT_SPEAK_RELAY = Status._(270, _omitEnumNames ? '' : 'HOP_CANT_SPEAK_RELAY');
  static const Status HOP_CANT_RELAY_TO_SELF = Status._(280, _omitEnumNames ? '' : 'HOP_CANT_RELAY_TO_SELF');
  static const Status STOP_SRC_ADDR_TOO_LONG = Status._(320, _omitEnumNames ? '' : 'STOP_SRC_ADDR_TOO_LONG');
  static const Status STOP_DST_ADDR_TOO_LONG = Status._(321, _omitEnumNames ? '' : 'STOP_DST_ADDR_TOO_LONG');
  static const Status STOP_SRC_MULTIADDR_INVALID = Status._(322, _omitEnumNames ? '' : 'STOP_SRC_MULTIADDR_INVALID');
  static const Status STOP_DST_MULTIADDR_INVALID = Status._(323, _omitEnumNames ? '' : 'STOP_DST_MULTIADDR_INVALID');
