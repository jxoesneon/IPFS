...
class ProtocolConfig extends $pb.GeneratedMessage {
  ...
  factory ProtocolConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ProtocolConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProtocolConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'ipfs.config'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'protocolId')
    ..a<$core.int>(2, _omitFieldNames ? '' : 'messageTimeoutSeconds', $pb.PbFieldType.OU3)
    ..a<$core.int>(3, _omitFieldNames ? '' : 'maxRetries', $pb.PbFieldType.OU3)
    ..a<$core.int>(4, _omitFieldNames ? '' : 'maxMessageSize', $pb.PbFieldType.OU3)
    ..aOM<RateLimitConfig>(5, _omitFieldNames ? '' : 'rateLimit', subBuilder: RateLimitConfig.create)
    ..aOM<CircuitBreakerConfig>(6, _omitFieldNames ? '' : 'circuitBreaker', subBuilder: CircuitBreakerConfig.create)
  ...
  @$pb.TagNumber(1)
  set protocolId($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set messageTimeoutSeconds($core.int v) { $_setUnsignedInt32(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set maxRetries($core.int v) { $_setUnsignedInt32(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set maxMessageSize($core.int v) { $_setUnsignedInt32(3, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set rateLimit(RateLimitConfig v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set circuitBreaker(CircuitBreakerConfig v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class RateLimitConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RateLimitConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'ipfs.config'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'maxRequestsPerWindow', $pb.PbFieldType.OU3)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'windowSeconds', $pb.PbFieldType.OU3)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set maxRequestsPerWindow($core.int v) { $_setUnsignedInt32(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set windowSeconds($core.int v) { $_setUnsignedInt32(1, v); }
  @$pb.TagNumber(2)
...
class CircuitBreakerConfig extends $pb.GeneratedMessage {
  ...
  factory CircuitBreakerConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CircuitBreakerConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CircuitBreakerConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'ipfs.config'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'resetTimeoutSeconds', $pb.PbFieldType.OU3)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'failureThreshold', $pb.PbFieldType.OU3)
    ..a<$core.int>(3, _omitFieldNames ? '' : 'halfOpenTimeoutSeconds', $pb.PbFieldType.OU3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  CircuitBreakerConfig clone() => CircuitBreakerConfig()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CircuitBreakerConfig copyWith(void Function(CircuitBreakerConfig) updates) => super.copyWith((message) => updates(message as CircuitBreakerConfig)) as CircuitBreakerConfig;
  ...
  static $pb.PbList<CircuitBreakerConfig> createRepeated() => $pb.PbList<CircuitBreakerConfig>();
  @$core.pragma('dart2js:noInline')
  static CircuitBreakerConfig getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CircuitBreakerConfig>(create);
  static CircuitBreakerConfig? _defaultInstance;

  @$pb.TagNumber(1)
  $core.int get resetTimeoutSeconds => $_getIZ(0);
  @$pb.TagNumber(1)
  set resetTimeoutSeconds($core.int v) { $_setUnsignedInt32(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set failureThreshold($core.int v) { $_setUnsignedInt32(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set halfOpenTimeoutSeconds($core.int v) { $_setUnsignedInt32(2, v); }
  @$pb.TagNumber(3)
