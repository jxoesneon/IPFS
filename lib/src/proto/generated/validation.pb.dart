...
class ValidationResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ValidationResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'ipfs.validation'), createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'isValid')
    ..aOS(2, _omitFieldNames ? '' : 'errorMessage')
    ..e<ValidationResult_ValidationCode>(3, _omitFieldNames ? '' : 'code', $pb.PbFieldType.OE, defaultOrMaker: ValidationResult_ValidationCode.UNKNOWN, valueOf: ValidationResult_ValidationCode.valueOf, enumValues: ValidationResult_ValidationCode.values)
  ...
  @$pb.TagNumber(3)
  set code(ValidationResult_ValidationCode v) { setField(3, v); }
  @$pb.TagNumber(3)
