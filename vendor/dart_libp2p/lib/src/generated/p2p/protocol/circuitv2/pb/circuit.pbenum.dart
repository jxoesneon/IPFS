...
//
// Generated from p2p/protocol/circuitv2/pb/circuit.proto.
...
class Status extends $pb.ProtobufEnum {
  ...
  static const Status RESERVATION_REFUSED =
      Status._(200, _omitEnumNames ? '' : 'RESERVATION_REFUSED');
  static const Status RESOURCE_LIMIT_EXCEEDED =
      Status._(201, _omitEnumNames ? '' : 'RESOURCE_LIMIT_EXCEEDED');
  static const Status PERMISSION_DENIED =
      Status._(202, _omitEnumNames ? '' : 'PERMISSION_DENIED');
  static const Status CONNECTION_FAILED =
      Status._(203, _omitEnumNames ? '' : 'CONNECTION_FAILED');
  static const Status NO_RESERVATION =
      Status._(204, _omitEnumNames ? '' : 'NO_RESERVATION');
  static const Status MALFORMED_MESSAGE =
      Status._(400, _omitEnumNames ? '' : 'MALFORMED_MESSAGE');
  static const Status UNEXPECTED_MESSAGE =
      Status._(401, _omitEnumNames ? '' : 'UNEXPECTED_MESSAGE');
