...
class NatTraversalStrategy {
  ...
  static TraversalStrategy selectStrategy(NatBehavior localBehavior) {
    ...
    if (localBehavior.mappingBehavior ==
            NatMappingBehavior.endpointIndependent &&
        localBehavior.filteringBehavior ==
  ...
  static TraversalStrategy selectPeerStrategy(
      NatBehavior localBehavior, NatBehavior remoteBehavior) {
    ...
    if (localBehavior.mappingBehavior ==
        ...
        localBehavior.filteringBehavior ==
            NatFilteringBehavior.endpointIndependent &&
        remoteBehavior.mappingBehavior ==
            NatMappingBehavior.endpointIndependent &&
        remoteBehavior.filteringBehavior ==
            NatFilteringBehavior.endpointIndependent) {
      return TraversalStrategy.direct;
    }
