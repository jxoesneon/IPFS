...
class SwarmConn implements Conn {
  ...
  void _setupHealthMonitoring() {
    try {
      ...
      _logger
          .warning('SwarmConn ($id): Error setting up health monitoring: $e');
    }
  }
  ...
  @override
  ConnState get state =>
      conn.state; // Delegate to the underlying connection's state
  ...
  ConnStats get stat {
    ...
    return _ConnStatsImpl(
      stats: Stats(
        ...
        limited: conn
            .stat.stats.limited, // Delegate 'limited' to underlying conn's stat
      ),
