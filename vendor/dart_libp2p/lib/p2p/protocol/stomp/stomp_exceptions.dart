...
abstract class StompException implements Exception {
  ...
  @override
  String toString() =>
      'StompException: $message${cause != null ? ' (caused by: $cause)' : ''}';
}
...
class StompFrameException extends StompException {
  ...
  @override
  String toString() =>
      'StompFrameException: $message${cause != null ? ' (caused by: $cause)' : ''}';
}
...
class StompProtocolException extends StompException {
  ...
  @override
  String toString() =>
      'StompProtocolException: $message${cause != null ? ' (caused by: $cause)' : ''}';
}
...
class StompConnectionException extends StompException {
  ...
  @override
  String toString() =>
      'StompConnectionException: $message${cause != null ? ' (caused by: $cause)' : ''}';
}
...
class StompAuthenticationException extends StompException {
  ...
  @override
  String toString() =>
      'StompAuthenticationException: $message${cause != null ? ' (caused by: $cause)' : ''}';
}
...
class StompSubscriptionException extends StompException {
  ...
  @override
  String toString() =>
      'StompSubscriptionException: $message${subscriptionId != null ? ' (subscription: $subscriptionId)' : ''}${cause != null ? ' (caused by: $cause)' : ''}';
}
...
class StompTransactionException extends StompException {
  ...
  const StompTransactionException(super.message,
      [this.transactionId, super.cause]);

  @override
  String toString() =>
      'StompTransactionException: $message${transactionId != null ? ' (transaction: $transactionId)' : ''}${cause != null ? ' (caused by: $cause)' : ''}';
}
...
class StompSendException extends StompException {
  ...
  @override
  String toString() =>
      'StompSendException: $message${destination != null ? ' (destination: $destination)' : ''}${cause != null ? ' (caused by: $cause)' : ''}';
}
...
class StompAckException extends StompException {
  ...
  @override
  String toString() =>
      'StompAckException: $message${messageId != null ? ' (message: $messageId)' : ''}${cause != null ? ' (caused by: $cause)' : ''}';
}
...
class StompFrameSizeException extends StompFrameException {
  ...
  const StompFrameSizeException(super.message, this.actualSize, this.maxSize,
      [super.cause]);

  @override
  String toString() =>
      'StompFrameSizeException: $message (actual: $actualSize, max: $maxSize)${cause != null ? ' (caused by: $cause)' : ''}';
}
...
class StompTimeoutException extends StompException {
  ...
  @override
  String toString() =>
      'StompTimeoutException: $message (timeout: ${timeout.inMilliseconds}ms)${cause != null ? ' (caused by: $cause)' : ''}';
}
...
class StompHeartBeatException extends StompException {
  ...
  @override
  String toString() =>
      'StompHeartBeatException: $message${cause != null ? ' (caused by: $cause)' : ''}';
}
...
class StompDestinationException extends StompException {
  ...
  const StompDestinationException(super.message,
      [this.destination, super.cause]);

  @override
  String toString() =>
      'StompDestinationException: $message${destination != null ? ' (destination: $destination)' : ''}${cause != null ? ' (caused by: $cause)' : ''}';
}
...
class StompServerErrorException extends StompException {
  ...
  const StompServerErrorException(super.message,
      [this.receiptId, this.headers, super.cause]);
...
class StompStateException extends StompException {
  ...
  const StompStateException(
      super.message, this.currentState, this.expectedState,
      [super.cause]);

  @override
  String toString() =>
      'StompStateException: $message (current: $currentState, expected: $expectedState)${cause != null ? ' (caused by: $cause)' : ''}';
}
