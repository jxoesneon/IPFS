...
class PrependedStream implements P2PStream<Uint8List> {
  ...
  Future<void> setProtocol(String protocol) =>
      _underlying.setProtocol(protocol);
  ...
  Future<void> setDeadline(DateTime? deadline) =>
      _underlying.setDeadline(deadline);

  @override
  Future<void> setReadDeadline(DateTime deadline) =>
      _underlying.setReadDeadline(deadline);

  @override
  Future<void> setWriteDeadline(DateTime deadline) =>
      _underlying.setWriteDeadline(deadline);
}
