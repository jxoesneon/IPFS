...
abstract class RelayServerMetricsObserver {
  ...
  void onRelayConnectRequested(PeerId srcPeer, PeerId dstPeer,
      {String? sessionId});

  /// Called when a relay connection is successfully established
  void onRelayConnectEstablished(PeerId srcPeer, PeerId dstPeer,
      {String? sessionId});

  /// Called when a relay connection fails to establish
  void onRelayConnectFailed(PeerId srcPeer, PeerId dstPeer, String reason,
      {String? sessionId});
  ...
  void onBytesRelayed(PeerId srcPeer, PeerId dstPeer, int bytes,
      {String? sessionId});
