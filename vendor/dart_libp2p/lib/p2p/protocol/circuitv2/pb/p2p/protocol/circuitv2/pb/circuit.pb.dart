...
class HopMessage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.List<$core.int>>(
        6, _omitFieldNames ? '' : 'diagnosticSessionId', $pb.PbFieldType.OY)
  ...
  @$pb.TagNumber(6)
  set diagnosticSessionId($core.List<$core.int> value) => $_setBytes(5, value);
  @$pb.TagNumber(6)
  $core.bool hasDiagnosticSessionId() => $_has(5);
  @$pb.TagNumber(6)
  void clearDiagnosticSessionId() => $_clearField(6);
}
...
class StopMessage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.List<$core.int>>(
        5, _omitFieldNames ? '' : 'diagnosticSessionId', $pb.PbFieldType.OY)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(5)
  set diagnosticSessionId($core.List<$core.int> value) => $_setBytes(4, value);
  @$pb.TagNumber(5)
  $core.bool hasDiagnosticSessionId() => $_has(4);
  @$pb.TagNumber(5)
  void clearDiagnosticSessionId() => $_clearField(5);
}
