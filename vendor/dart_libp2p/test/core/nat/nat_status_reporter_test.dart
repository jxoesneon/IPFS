...
void main() {
  group('NatStatusReporter', () {
    ...
    test('should report current NAT behavior', () {
      ...
      expect(behavior.mappingBehavior,
          equals(NatMappingBehavior.endpointIndependent));
      expect(behavior.filteringBehavior,
    ...
    test('should provide status summary', () {
      ...
      expect(summary['currentBehavior']['mappingBehavior'],
          equals('endpointIndependent'));
      expect(summary['currentBehavior']['filteringBehavior'],
          equals('addressDependent'));
      ...
      expect(summary['recommendedStrategyDescription'],
          equals('UDP hole punching'));
    ...
    test('should provide detailed report with history', () {
      ...
      expect(report['history'][0]['mappingBehavior'],
          equals('endpointIndependent'));
      expect(report['history'][0]['filteringBehavior'],
          equals('addressDependent'));
    ...
    test('should provide peer strategy description', () {
      ...
      final description =
          reporter.getRecommendedPeerStrategyDescription(remoteBehavior);
    ...
    test('should trigger behavior update', () async {
      ...
      expect(updatedBehavior.mappingBehavior,
          equals(NatMappingBehavior.addressDependent));
      expect(updatedBehavior.filteringBehavior,
