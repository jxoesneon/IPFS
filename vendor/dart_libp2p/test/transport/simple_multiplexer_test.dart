...
void main() {
  ...
  group('Simple Multiplexer Tests', () {
    test('basic multiplexer stream creation', () async {
      ...
      final securedConn =
          await mockSecurityProtocol.secureOutbound(mockTransportConn);
      ...
      final muxedConn = await multiplexerFactory.newConnOnTransport(
          securedConn, false, mux.NullScope()) as mux.StreamlinedMockMuxedConn;
    ...
    test('multiplexer with muxed connection', () async {
      ...
      print(
          'Created multiplexer, initial streams: ${multiplexer.totalStreamsCreated}');

      // Create a muxed connection
      final muxedConn =
          mux.StreamlinedMockMuxedConn(securedConn, false, multiplexer);
      ...
      final stream1 =
          await muxedConn.openStream(Context()) as mux.StreamlinedMockStream;
