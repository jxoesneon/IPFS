...
class ConeToConeSucessScenario extends HolePunchScenario {
  ...
  Future<void> setup() async {
    ...
    if (orchestrator.isStarted) {
      print(
          '🔄 Stopping existing infrastructure to apply new NAT configuration...');
...
class MixedNATScenario extends HolePunchScenario {
  ...
  Future<void> setup() async {
    ...
    print(
        '🔧 Starting infrastructure with Mixed NAT configuration (Cone + Symmetric)...');
    await orchestrator.start();
  ...
  Future<void> teardown() async {
    ...
    try {
      ...
      final peerBLogs =
          await orchestrator.getLogs('peer-b'); // All logs to see full startup
      ...
      final natBLogs = await orchestrator
          .getLogs('nat-gateway-b'); // All logs to see full NAT setup
...
class ScenarioResult {
  ...
  factory ScenarioResult.success(String message,
  ...
  factory ScenarioResult.failure(String message,
      [Map<String, dynamic>? metrics]) {
    return ScenarioResult(
      success: false,
      message: message,
