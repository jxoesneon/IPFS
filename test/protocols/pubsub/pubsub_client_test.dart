...
void main() {
  ...
  group('PubSubClient', () {
    ...
    test('publish sends message to mesh peers', () async {
      ...
      final captured = verify(mockRouter.sendMessage(peer1, captureAny)).captured.single as Uint8List;
    ...
    test('handles GRAFT and PRUNE actions', () async {
      ...
      // GRAFT
      pubsubHandler(NetworkPacket(
        srcPeerId: peerId,
        datagram: Uint8List.fromList(utf8.encode(jsonEncode({
          'action': 'graft',
          'sender': peerId,
          'topic': 'any',
        }))),
    ...
    test('handles IHAVE and sends IWANT', () async {
      ...
      final captured = verify(mockRouter.sendMessage(sender, captureAny)).captured.single as Uint8List;
