...
void main() {
  group('Keystore', () {
    ...
    test('verifySignature - simple hex pubkey', () async {
      ...
      final isValid = await keystore.verifySignature(pubHex, data, Uint8List.fromList(signature.bytes));
    ...
    test('verifySignature - base64 pubkey', () async {
      ...
      final isValid = await keystore.verifySignature(pubBase64, data, Uint8List.fromList(signature.bytes));
      expect(isValid, isTrue);
    });
