  ...
  group('IPLDPathHandler', () {
    ...
    group('parsePath', () {
      ...
      test('parses valid IPFS path with subpath', () {
        final (namespace, cid, remaining) = IPLDPathHandler.parsePath('/ipfs/$validCidString/folder/file.txt');
        expect(namespace, 'ipfs');
      ...
      test('throws IPLDPathError on missing leading slash', () {
        expect(() => IPLDPathHandler.parsePath('ipfs/$validCidString'), throwsA(isA<IPLDPathError>()));
      });

       test('throws IPLDPathError on invalid namespace', () {
        expect(() => IPLDPathHandler.parsePath('/invalid/$validCidString'), throwsA(isA<IPLDPathError>()));
      });
    ...
    group('normalizePath', () {
      test('removes duplicate slashes', () {
        expect(IPLDPathHandler.normalizePath('//ipfs///$validCidString//path'), '/ipfs/$validCidString/path');
      });
