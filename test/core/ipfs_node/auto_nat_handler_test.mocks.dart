...
import 'package:dart_ipfs/src/network/nat_traversal_service.dart' as _i12;
...
class MockNatTraversalService extends _i1.Mock
    implements _i12.NatTraversalService {
  MockNatTraversalService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i8.Future<List<String>> mapPort(int? port, {Duration? leaseDuration}) =>
      (super.noSuchMethod(
            Invocation.method(
              #mapPort,
              [port],
  ...
  @override
  _i8.Future<void> unmapPort(int? port) =>
      (super.noSuchMethod(
