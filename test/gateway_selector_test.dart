...
void main() {
  group('Gateway Selector Integration', () {
    ...
    test('GatewayMode.public uses default ipfs.io logic (Integration Check)',
      ...
      await node.cat(
          'test_cid'); // This might hang or return null if offline/internet issues
