# Maintainer Decision — CAR Migration for dart_ipfs

**Decision ID:** `MAINTAINER_DECISION_CAR_MIGRATION`  
**Date:** 2026-06-25  
...
Option A wins on capability, efficiency, and evolution. It is slightly behind C and D on safety, but the safety gap is mitigated because the old API is not public and the v2.0 release already authorizes a breaking change. Option D is a close second but adds a milestone of legacy code that the maintainers does not believe is necessary.
