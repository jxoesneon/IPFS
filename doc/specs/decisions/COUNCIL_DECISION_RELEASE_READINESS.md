# Ciel Council of Five — Release Readiness Verdict
...
| Council of Five audit | closed | All mandatory amendments and optional recommendations completed |
...
3. Run the full `quic_lib` verification commands from `AGENTS.md`.
...
**Wings:** `dart_quic`, `dart_ipfs_quic`, `ciel_orchestration`, `security_audits`
