...
void main() {
  group('MultibaseUtils RFC4648', () {
    ...
    test('base32 round-trips and decodes standard strings', () {
      final cidBytes = Uint8List.fromList([1, 85, 18, 32, 3, 144, 88, 198, 242, 192, 203, 73, 44, 83, 59, 10, 77, 20, 239, 119, 204, 15, 120, 171, 204, 206, 213, 40, 125, 132, 161, 162, 1, 28, 251, 129]);
      expect(MultibaseUtils.decode('bafkreiadsbmmn4waznesyuz3bjgrj33xzqhxrk6mz3ksq7meugrachh3qe'), equals(cidBytes));
    });
    test('base16/base64/base64url round-trip', () {
      for (final base in [mb.Multibase.base16, mb.Multibase.base16upper, mb.Multibase.base64, mb.Multibase.base64url, mb.Multibase.base64urlpad, mb.Multibase.base32upper]) {
        expect(MultibaseUtils.decode(MultibaseUtils.encode(base, data)), equals(data), reason: '$base');
      }
    });
    test('base58btc still round-trips via package', () {
      expect(MultibaseUtils.decode(MultibaseUtils.encode(mb.Multibase.base58btc, data)), equals(data));
    });
